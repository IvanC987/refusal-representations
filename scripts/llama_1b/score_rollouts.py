...
def main():
    rollout_path = PROJECT_ROOT / "experiments" / "llama_outputs_1b" / f"sequential_rollouts_tier_2.json"
    ...
    output_path = PROJECT_ROOT / "experiments" / "llama_outputs_1b" / f"sequential_rollouts_tier_2_evaluated.json"
