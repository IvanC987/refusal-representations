...
def main():
    input_path = PROJECT_ROOT / "experiments" / "llama_outputs_8b" / "sequential_rollouts_evaluated.json"
    ...
    output_path = PROJECT_ROOT / "experiments" / "llama_outputs_8b" / "sequential_aggregate_metrics.json"
